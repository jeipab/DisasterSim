...
func update_all_UI(card: Dictionary) -> void:
	...
	phase_text += game_manager.current_state_to_string()
...
func _on_state_changed(new_state) -> void:
	update_all_UI(game_manager.current_card)

func _on_card_drawn(new_card) -> void:
...
func _ready() -> void:
	...
	game_manager.connect("card_drawn", _on_card_drawn)
